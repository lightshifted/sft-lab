# Replace the original sft_dataset.py in sft-lab/verl/verl/utils/dataset/sft_dataset.py with this file.
"""
SFT dataset
...
class SFTDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        if isinstance(self.prompts, pd.DataFrame):
            print("Warning: self.prompts is a DataFrame, converting to Series")
            self.prompts = self.prompts.iloc[:, 0]  # Take first column if multi-column
